...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "flex flex-wrap items-center gap-2 bg-transparent dark:bg-input/30 bg-clip-padding shadow-xs px-2.5 has-data-[slot=combobox-chip]:px-1.5 py-2 border border-input aria-invalid:border-destructive aria-invalid:focus-within:border-destructive focus-within:border-ring dark:aria-invalid:border-destructive/50 rounded-md aria-invalid:focus-within:ring-destructive/50 focus-within:ring-[3px] focus-within:ring-ring/50 min-h-10 text-sm transition-[color,box-shadow]",
        className,
      )}
      {...props}
    />
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "flex justify-center items-center gap-1 bg-secondary has-disabled:opacity-50 ps-2 pe-1 rounded-md w-fit h-7 font-medium text-secondary-foreground text-xs whitespace-nowrap transition-colors has-disabled:cursor-not-allowed has-disabled:pointer-events-none",
        className,
      )}
      {...props}
    >
